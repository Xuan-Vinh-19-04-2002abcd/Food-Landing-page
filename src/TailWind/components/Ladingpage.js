    ...
    return (
        <>
            <header>
                <div className='container mx-auto px-4 '>
                    <nav className='flex justify-between items-center py-5'>
                        <div className="w-32 lg:w-full z-20">
                        ...
                        {showMenu && <ul className="fixed top-0 left-0 w-full h-screen flex flex-col justify-center items-center
                         bg-gray-900 bg-opacity-80 md:bg-transparent md:h-auto md:flex-row md:justify-between md:static " id="menu">
            ...
            <section>
                ...
                <div className="w-full bg-no-repeat bg-cover relative h-custom" style={{ backgroundImage: `url("./image/banner.png")` }}>
            ...
            <section>
                <div style={{ backgroundImage: `url("./image/banner1.png")` }} className="relative w-full h-custom bg-no-repeat bg-cover">
                    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-center z-10 ">
                        ...
                        <div className="flex justify-center">
                            <button className="mx-4 border border-transparent bg-red-500 rounded-xl px-10 py-2 hover:bg-transparent hover:border-white hover:transition-all">Buy now</button>
                            <button className="mx-4 border border-transparent bg-red-500 rounded-xl px-10 py-2 hover:bg-transparent hover:border-white hover:transition-all">Try for free</button>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div className="flex flex-col justify-between items-center py-5 md:flex-row">
                            ...
                            <div className="flex items-center text-gray-500">
                                <a href="tel:0879364221" className="flex ms-4">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                         stroke="currentColor" className="w-6 h-6 text-red-500 mr-4">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                              d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z"/>
                                    </svg>
                                    <p>098-936-4221</p>
                                </a>
                                <a href="mailto:xuandangvinh@gmail.com">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                         stroke="currentColor" className="w-6 h-6">
                                        <path stroke-linecap="round" stroke-linejoin="round"
